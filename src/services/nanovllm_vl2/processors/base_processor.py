...
from nanovllm.engine.mm_io_struct import MultimodalDataItem, Modality
from nanovllm.engine.mm_utils import load_image, load_video
from nanovllm.util import logger
...
class BaseMultimodalProcessor(ABC):
    ...
    def process_mm_data(
        self, input_text, images=None, videos=None, **kwargs
    ):
        """
    ...
    def load_mm_data(
        ...
        Args:
            multimodal_tokens (list[str]): list of special token which denoting a single multimodal data
                e.g. image token or video token
    ...
    def _process_and_collect_mm_items(
        self, input_text: str, images=None, videos=None, **kwargs
        ...
        ret = self.process_mm_data(
            input_text=input_text, images=images, videos=videos, **kwargs
        )
    ...
    def process_and_combine_mm_data(
        ...
        **kwargs,
        ...
        Supports mixed modalities (images and video in the same request).
        ...
        dict_items, raw_images, raw_videos = [], [], []
