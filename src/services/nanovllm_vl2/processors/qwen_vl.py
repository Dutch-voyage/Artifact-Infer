...
from nanovllm.layers.rotary_embedding import MRotaryEmbedding
from nanovllm.models.qwen2_5_vl import Qwen2_5_VLForConditionalGeneration
from nanovllm.processors.base_processor import BaseMultimodalProcessor, MultimodalSpecialTokens
...
class Qwen2_5VLMultiModalProcessor(BaseMultimodalProcessor):
    models = [
